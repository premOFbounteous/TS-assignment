...
// type Task=emailTaskType | logTaskType
...
// function processTask(task:emailTaskType):string
// function processTask(task:logTaskType):string
...
// const tasks:Task[] = [
//   { type: "email", address: "test@test.com", id: 1 },
//   { type: "log", message: "User logged in" }
// ];

// function processGenericTask<T>(task: T): string {
//   if (task.type === "email") {
//     return `Email to: ${task.address}`;
//   } else if (task.type === "log") {
//     return `Log message: ${task.message}`;
//   } else {
//     return "Unknown task";
//   }
// }

// tasks.map(processGenericTask)
